...
export class MockMortgageAdapter {
  ...
  async startLogin({route,rememberOnThisMac=false}={}){ return {adapter:'mock',authenticated:true,live:false,readOnly:true,setupRequired:false,loginRoute:route,rememberOnThisMac}; }
